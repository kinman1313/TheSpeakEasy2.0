...
export async function PATCH(
    ...
    try {
        await limiter.check(request, 120, "UPDATE_MESSAGE_REACTION") // 120 reactions per minute
        ...
        const messageData = messageSnap.data() as MessageData & { reactions?: Record<string, string[]> }
        ...
        console.error("Message reaction update error:", error)
